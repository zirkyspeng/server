...
# Seekable on-demand streams: advertise both time- and byte-seek capability.
# Some renderers (including recent Marantz firmware) do not expose AVTransport/Seek
# unless the byte-seek bit is also present, even when the actual reconnect uses NPT.
DLNA_CONTENT_FEATURES_TIME_SEEK = "DLNA.ORG_OP=11;DLNA.ORG_FLAGS=01700000000000000000000000000000"
